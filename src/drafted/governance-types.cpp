...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MocacoinNetwork") type = MocacoinNetwork;
    if(strType == "MocacoinNetworkVariable") type = MocacoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MocacoinNetwork) s = "MocacoinNetwork";
    if(type == MocacoinNetworkVariable) s = "MocacoinNetworkVariable";
