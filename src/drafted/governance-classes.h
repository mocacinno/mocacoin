 ...
 *
 *   // network
 *   CMocacoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mocacoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMocacoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMocacoinNetwork(UniValue objIn)
    {
...
// // can be under: MocacoinNetwork
// //   -- signature requirements : Key1(User)
// class CMocacoinNetworkVariable : public CGovernanceObject
// {
// private:
