...
{
    if(fLiteMode) return; // ignore all Mocacoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Mocacoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("mocacoin-privatesend");
