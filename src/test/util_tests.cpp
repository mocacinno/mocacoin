...
BOOST_AUTO_TEST_CASE(test_ParseFixedPoint)
{
    ...
    BOOST_CHECK(ParseFixedPoint("1983198399.19831983", 8, &amount));
    BOOST_CHECK_EQUAL(amount, 198319831983198399LL);
    BOOST_CHECK(ParseFixedPoint("-1983198399.19831983", 8, &amount));
    BOOST_CHECK_EQUAL(amount, -198319831983198399LL);
    ...
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("-19831983999.19831983", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("19839901983.01983999", 8, &amount));
