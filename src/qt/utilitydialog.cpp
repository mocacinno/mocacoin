    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Mocacoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Mocacoin Core"));
...
All the Mocacoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MOCACOIN, 0.1 MOCACOIN, 1 MOCACOIN and 10 MOCACOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://mocacoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://mocacoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Mocacoin Core is shutting down...") + "<br /><br />" +
