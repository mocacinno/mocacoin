    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Mocacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Mocacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mocacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mocacoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Mocacoin Core help message to get a list with possible Mocacoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mocacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mocacoin network", "", count));
}
...
{
    QString strTitle = tr("Mocacoin Core"); // default title
