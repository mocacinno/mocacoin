    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MOCACOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("MOCACOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MOCACOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MOCACOIN-traditional"), QVariant("trad"));
