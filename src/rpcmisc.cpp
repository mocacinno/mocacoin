...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized mocacoin balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "mocacoin|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "mocacoin")
            + HelpExampleRpc("debug", "mocacoin,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"mocacoinaddress\"\n"
            "\nReturn information about the given mocacoin address.\n"
            "\nArguments:\n"
            "1. \"mocacoinaddress\"     (string, required) The mocacoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"mocacoinaddress\", (string) The mocacoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Mocacoin address and we have full public key:
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"mocacoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"mocacoinaddress\"  (string, required) The mocacoin address to use for the signature.\n"
