...
Only requiring some minor changes is mocacoin.cpp.
...
Changes to mocacoin.cpp
----------------------
mocacoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
