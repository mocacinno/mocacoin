...
Clone the git repositories for Mocacoin Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/mocacoinpay/mocacoin
```
...
in the Mocacoin Core repository under 'Fetch and build inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Mocacoin Core repository.
...
```bash
    ...
    From https://github.com/mocacoinpay/mocacoin
...
For example:
```bash
URL=https://github.com/crowning-/mocacoin.git
...
BTCPATH=/some/root/path/mocacoin.git
SIGPATH=/some/root/path/mocacoin-detached-sigs.git
...
[mocacoin/gitian.sigs](https://github.com/mocacoinpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
