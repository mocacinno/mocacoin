...
This mechanism has been integrated into Bitcore-Node-Mocacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mocacoinpay/insight-api-mocacoin#web-socket-api](https://github.com/mocacoinpay/insight-api-mocacoin#web-socket-api) 
* API: [https://github.com/mocacoinpay/insight-api-mocacoin#instantsend-transactions](https://github.com/mocacoinpay/insight-api-mocacoin#instantsend-transactions) 
...
By default, the Mocacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mocacoin Core daemon:
